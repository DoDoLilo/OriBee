...
public class SNTPClient {
    ...
    public interface Listener {
        void onTimeResponse(Long localTime, Long remoteTime);
    }
    ...
    public static void getDate(TimeZone _timeZone, String hostAddress, Listener _listener) {

        new Thread(() -> {

            SNTPClient sntpClient = new SNTPClient(_listener);

            if (sntpClient.requestTime(hostAddress, 5000)) {
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).post(() -> _listener.onTimeResponse(sntpClient.localTime, date.getTime()));
